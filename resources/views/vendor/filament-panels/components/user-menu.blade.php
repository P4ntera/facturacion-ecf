...
@php
    ...
    // Rol del usuario en la empresa activa (spatie/laravel-permission con teams): Filament no
    // trae de fábrica un subtítulo de rol bajo el nombre en el bloque de usuario, así que se
    // agrega acá (ver diseño aprobado — bloque de usuario al pie del sidebar).
        ...
        @else
            ...
            >
                ...
                <span
                    ...
                    @endif
                    class="fi-user-menu-trigger-text-ctn"
                >
                    <span class="fi-user-menu-trigger-text">
                        {{ filament()->getUserName($user) }}
                    </span>

                    @if (filled($rolUsuario))
                        <span class="fi-user-menu-trigger-role">
                            {{ $rolUsuario }}
                        </span>
                    @endif
                </span>
